...
// change headr with button click
...
function changeButtonText() {
    if (document.body.classList.contains('dark')) {
        changeThemeButton.textContent = 'Switch to the Light Theme';
    } else {
        changeThemeButton.textContent = 'Switch to the Dark Theme';
    }
}
